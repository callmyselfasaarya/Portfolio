  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute inset-0" style={{ y: y2 }}>
        <motion.div 
          className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-blue-400 to-purple-600 rounded-full mix-blend-multiply filter blur-xl opacity-30 dark:mix-blend-screen dark:opacity-20"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 30, 0],
            y: [0, -20, 0],
        ...
        />
        <motion.div 
          className="absolute top-40 right-20 w-96 h-96 bg-gradient-to-r from-purple-400 to-pink-600 rounded-full mix-blend-multiply filter blur-xl opacity-30 dark:mix-blend-screen dark:opacity-20"
          animate={{
            scale: [1.2, 1, 1.2],
            x: [0, -40, 0],
            y: [0, 30, 0],
        ...
        />
        <motion.div 
          className="absolute bottom-20 left-1/2 w-80 h-80 bg-gradient-to-r from-teal-400 to-blue-600 rounded-full mix-blend-multiply filter blur-xl opacity-30 dark:mix-blend-screen dark:opacity-20"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, 20, 0],
            rotate: [0, 180, 360],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center z-10">
        ...
        >
          <motion.div variants={itemVariants} className="mb-6">
            <motion.span 
              className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 dark:border-blue-400/30 text-sm font-medium mb-4"
              whileHover={{ 
                scale: 1.05,
          ...
          >
            ...
            >
              <Button
                ...
                className="border-2 border-gray-300 hover:border-gray-400 dark:border-gray-600 dark:hover:border-gray-500 px-8 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
              >
      ...
      <motion.div
        ...
        style={{ opacity }}
      >
        <ChevronDown size={32} className="text-gray-400 dark:text-gray-500 cursor-pointer" />
      </motion.div>
    </motion.section>
  );
};
